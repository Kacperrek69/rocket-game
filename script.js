...
function smierc(x, y){
    ...
    newOkno.style.fontSize = "2.5vw";
    newOkno.innerHTML = "<h1 style='margin-top:10%; text-shadow: 5px 4px 4px #CE0000;'>Przegrałeś</h1><button class='button' type='button' type='submit' style='margin-top: 10%;' onclick='window.location.reload(true);'>Restart</button>";
}
